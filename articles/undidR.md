...
init <- create_init_csv(silo_names = c("73", "46", "71", "58"),
                        ...
                        treatment_times = c("control", "control",
                                            "1991", "1991"))
#> init.csv saved to: /tmp/Rtmp1Qzt4P/init.csv
init
...
#> empty_diff_df.csv saved to: /tmp/Rtmp1Qzt4P/empty_diff_df.csv
empty_diff_df
...
#> filled_diff_df_71.csv saved to: /tmp/Rtmp1Qzt4P/filled_diff_df_71.csv
#> trends_data_71.csv saved to: /tmp/Rtmp1Qzt4P/trends_data_71.csv
